...
describe('HistorialPedidosEntrantesComponent', () => {
  ...
  const pedidosMock = [
    {
      id: 1, fecha: '2024-11-12T10:00:00', precioTotal: 100, estado: 'Enviado', tipo: 'entrante', Productos: [
        { id: 1, nombre: 'Gafas', precio: 50, stock: 30, PedidoProducto: { cantidad: 2 } }
      ]
    },
    {
      id: 2, fecha: '2024-11-11T15:00:00', precioTotal: 50, estado: 'Enviado', tipo: 'entrante', Productos: [
        { id: 1, nombre: 'Gafas', precio: 50, stock: 30, PedidoProducto: { cantidad: 2 } }
      ]
    },
    {
      id: 3, fecha: '2024-11-10T09:00:00', precioTotal: 200, estado: 'Enviado', tipo: 'entrante', Productos: [
        { id: 1, nombre: 'Gafas', precio: 50, stock: 30, PedidoProducto: { cantidad: 2 } }
      ]
    },
  ];
